...
public:
    ...
    void run(size_t k_feat,size_t niter, size_t dec,size_t n_rec,double init_w_content, double init_w_social,bool learn=true,Options options=Options::onevalue);
